...
func (o *OrderHandler) GetAllDraftedOrders(ctx *gin.Context) {
	...
	orders, totalOrders, err := o.orderService.GetAllDraftedOrders(ctx, searchParams.Query, searchParams.Limit, searchParams.Offset)
	if err != nil {
		common.HandleError(ctx, err)
