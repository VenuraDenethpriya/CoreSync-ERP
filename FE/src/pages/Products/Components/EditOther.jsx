...
export function EditOther({ productData, onUpdate }) {
  ...
  useEffect(() => {
    if (open && productData) {
      ...
      setBrandName(productData.Specifications);
      ...
      <DialogContent className="sm:max-w-[1200px]">
        ...
        <div className="grid sm:grid-cols-2 grid-cols-1 gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-start gap-4">
            <Label htmlFor="BrandName" className="justify-self-start text-left mt-2">
              Brand Name
            </Label>
            <Input
              id="BrandName"
        ...
        <DialogFooter>
          <Button className="bg-blue-800 hover:bg-blue-900" onClick={handleEditSubmit}>
            Save changes
          </Button>
        </DialogFooter>
      </DialogContent>
