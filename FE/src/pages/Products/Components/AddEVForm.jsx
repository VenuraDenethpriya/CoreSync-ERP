    ...
    async function handleSubmit(values) {
        ...
        try {
            ...
            if (tesponse.message == "success") {
                ...
                toast.error("Error adding E-vehicle! " + tesponse.message, { position: "bottom-right" });
            }
        } catch (error) {
                                    ...
                                    <FormItem>
                                        ...
                                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                                            ...
                                            <SelectContent>
                                                ...
                                                <SelectItem value="Electric Threewheel">Electric Threewheel</SelectItem>
