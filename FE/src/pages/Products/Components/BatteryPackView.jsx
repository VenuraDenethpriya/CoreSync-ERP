...
function BatteryPackView() {
    ...
    const handleDelete = async () => {
        try {
            ...
            toast.error("Battery pack deleted successfully!", { position: "bottom-right" });
            navigate("/products");
        } catch (error) {
    ...
    return (
        <>
            ...
            <div className="sm:p-8 p-4 space-y-6 bg-gray-50 min-h-screen">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
...

                    {
                        isMobile ? null : <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
                            <EditBatteryPack productData={productData} onUpdate={handleProductUpdate} />
                           
                            <DeleteAlert handleDelete={handleDelete} productData={productData} />
                           

                            <PDFDownloadLink
                                document={<BatteryPackDetailsTemplate productData={productData} />}
                ...
                <div className="sm:pl-6 space-y-4">
                    <div className="">
                    ...
                    <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
                            <div className="space-y-2">
                                <DetailRow label="Pack Type" value={productData.type} />
                                <DetailRow label="Cell Count" value={productData.cell_count} />
                                <DetailRow label="Cell Type" value={productData.cell_type} />
                                <DetailRow label="BMS Type" value={productData.bms_type} />
                                <DetailRow label="Monitor" value={productData.monitor} />
                            </div>
                            <div className="space-y-2">
                                <DetailRow label="Capacity" value={productData.capacity + " Ah"} />
                                <DetailRow label="Voltage" value={productData.voltage + " V"} />
