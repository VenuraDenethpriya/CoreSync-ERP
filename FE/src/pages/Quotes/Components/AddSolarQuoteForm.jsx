...
const formSchema = z.object({
    ...
    PanelType: z.string().min(1, { message: "Solar panel type is required" }),
    Inverter: z.string().min(1, { message: "Inverter type is required" }),
...
const AddSolarQuoteForm = () => {
    ...
    async function handleSubmit(values) {
        try {
            ...
            toast.success("Solar panel added successfully!", { position: "bottom-right" });
            navigate("/products");
        } catch (error) {
...
export default AddSolarQuoteForm