...
import { UserTable } from "./Components/UsersTableCard.page";
import { useAuth, useUser } from "@clerk/clerk-react";
import { LockIcon } from "lucide-react";
import { Roles } from "@/const/const";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs"
import { LogsTable } from "./Components/LogsTableCard.page";
...
const Users = () => {
  ...
  if (user.publicMetadata.role == Roles.HEAD || user.publicMetadata.role == Roles.WAREHOUSE_STAFF || user.publicMetadata.role == Roles.INVENTORY_MANAGER || user.publicMetadata.role == Roles.OFFICE_STAFF) {
    return (
      <div className="flex items-center justify-center h-[80vh] px-4">
        <div className="bg-white shadow-md rounded-xl p-8 max-w-lg text-center border border-red-200">
          <div className="flex flex-col items-center justify-center gap-3">
          ...
          <TabsContent value="users">
            ...
            <div className="">
              ...
              <div className="mx-3 sm:max-w-screen">
                <UserTable setExportData={setExportData} />
              </div>
            </div>
          </TabsContent>
