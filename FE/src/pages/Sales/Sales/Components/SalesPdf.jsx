      ...
      <View style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>{saleData.type}</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Commission</Text>
            <Text style={styles.detailValue}>{saleData.commission}</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Date</Text>
            <Text style={styles.detailValue}>{new Date(saleData.date).toLocaleString('en-US', {
                                year: 'numeric',
                                month: 'long', 
                                day: 'numeric',
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>{saleData.customer_name}</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Customer Phone No.</Text>
            <Text style={styles.detailValue}>{saleData.customer_phone}</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Recording</Text>
            <Text style={styles.detailValue}>{saleData.recording_url}</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Description</Text>
            <Text style={styles.detailValue}>{saleData.description}</Text>
          </View>
        </View>
      </View>
