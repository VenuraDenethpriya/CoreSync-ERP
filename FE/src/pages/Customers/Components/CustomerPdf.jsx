...
const CustomerTemplate = ({ customerData }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Phone No 1.</Text>
            <Text style={styles.detailValue}>{customerData.phone_no1}</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Phone No 2.</Text>
            <Text style={styles.detailValue}>{customerData.phone_no2}</Text>
          </View>
          <View style={styles.detailRow}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>{customerData.address}</Text>
          </View>
        </View>
        ...
        {customerData.quotes?.length > 0 && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Associated Quotes</Text>
            {customerData.quotes
              .filter((quote) => quote && quote.quote_no)
              .map((quote, index) => (
                <View key={quote.quote_no || index} style={styles.subSection}>
        ...
        {customerData.orders?.length > 0 && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Associated Orders</Text>
            {customerData.orders
              .filter((order) => order && order.order_no)
              .map((order, index) => (
                <View key={order.order_no || index} style={styles.subSection}>
                  <Text style={styles.quoteTitle}>
                  ...
                  <View style={styles.detailRow}>
                    ...
                    <Text style={styles.detailValue}>{order.order_status}</Text>
                  </View>
                  <View style={styles.detailRow}>
